...
public anywheresoftware.b4a.objects.EditTextWrapper _emessage = null;
public anywheresoftware.b4a.objects.EditTextWrapper _eresponse = null;
...
public static String  _bsend_click() throws Exception{
RDebugUtils.currentModule="main";
String _s_address = "";
int _s_port = 0;
